...
export async function getFamilyMoods(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/family/moods?${params}`);
...
export async function getMoodStats(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/family/moods/stats?${params}`);
...
export async function getMoodTrend(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/family/moods/trend?${params}`);
