...
export async function createMoodRecord(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/elderly/moods`, {
      method: 'POST',
      headers: {
...
export async function getMoodRecords(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/elderly/moods?${params}`);
...
export async function getTodayMoods(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/elderly/moods/today?${params}`);
...
export async function getLatestMood(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/elderly/moods/latest?${params}`);
