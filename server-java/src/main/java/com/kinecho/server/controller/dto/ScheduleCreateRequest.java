...
@Schema(description = "Create a family care schedule or reminder.")
public record ScheduleCreateRequest(
    @JsonProperty("family_id")
    @Schema(description = "Family scope for the schedule.", example = "family_001")
    ...
    @NotBlank(message = "schedule_time is required")
    ...
    @Schema(description = "Optional creator user id.", example = "7")
    @Positive(message = "created_by must be positive")
    Long createdBy
) {
